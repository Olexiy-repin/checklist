...
gulp.task('html-folder', function(){
  return gulp.src('./src/html/checklist/*.html')
    .pipe(rigger())
    .pipe(htmlmin({
      collapseWhitespace: true
    }))
    .pipe(gulp.dest('./dist/checklist'))
      .pipe(browserSync.reload({
        stream: true
      }));
});
...
gulp.task('watch', function(){
  ...
  gulp.watch('./src/html/**/*.html', ['html-folder']);
...
// BUILD TASK
gulp.task('build', ['html', 'html-folder', 'all', 'html-suc', 'css', 'js', 'img', 'fonts', 'db']);
